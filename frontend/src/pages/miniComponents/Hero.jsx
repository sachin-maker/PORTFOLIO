    ...
    >
      ...
      <h1 className="text-[1.8rem] sm:text-[2rem] md:text-[2.5rem] lg:text-[3rem] tracking-wide mb-3">
        ...
        <motion.span 
          ...
          animate={{ 
            textShadow: ["0px 0px 10px rgba(75, 0, 130, 0.7)", "0px 0px 2px rgba(75, 0, 130, 0.4)"],
      ...
      >
        <Link to={user.githubURL} target="_blank">
          <Button 
            className="rounded-full flex items-center gap-2 px-6 py-2 bg-gray-900 text-white hover:bg-gray-700 transition-all relative overflow-hidden"
          >
            <Github />
            Github
            <motion.span 
